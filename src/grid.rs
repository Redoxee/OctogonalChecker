...
impl Grid{
    ...
    pub fn get_index_from_coord(&self, coord: TileCoord) -> Option<usize> {
    ...
    pub fn get_index_from_coord_unsafe(&self, coord: TileCoord) -> usize {
    ...
    pub fn get_coord_from_index(&self, index : usize) -> TileCoord {
